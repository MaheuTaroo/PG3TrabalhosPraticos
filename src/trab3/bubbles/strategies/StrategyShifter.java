...
public class StrategyShifter implements Strategy {
	...
	public StrategyShifter(int min) {
		this.minimum = min;
	}
	public StrategyShifter() {
		this(2);
	}
	 ...
	 * colunas ocupadas pelas bolhas selecionadas e são deslocadas
	 * para a esquerda o número total de linhas ocupadas pelas bolhas
	 * selecionadas.
	 * @param board tabuleiro
	 */
	...
	public String toString() { return "shifter"; }
}
